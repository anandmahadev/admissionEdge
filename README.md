...
- **Icons**: Custom Inline SVGs & Lucide-inspired paths
...
- **Optimized Metadata**: Includes descriptive title tags and meta descriptions for better search ranking.
- **Performance Focused**: No heavy frameworks or large external libraries — ensuring near-instant load times.
- **Accessible Design**: High contrast ratios and clear focus states for better usability.

## 📄 License

© 2024 AdmissionEdge Mangalore. All rights reserved.
